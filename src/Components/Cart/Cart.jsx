...
const Cart = () => {
  const { cart, clearCart, getTotalPrice, deleteProductById, getTotalQuantity } =
  ...
  if(orderId){
    return (
      <div>
        ...
        <h4>El código de comprobante es : {orderId}</h4>
      ...
      {!showForm ? (
        <div className="cart-container">
              ...
              return (
                <div key={item.id} className="cart-item">
                  ...
                  <div className="cart-item-info">
                    <h2 className="cart-item-">{item.title}</h2>
          ...
          <div className="cart-info">
            ...
            <h3>Cantidad de productos: {getTotalQuantity()} </h3>
